...
/// existing account.
///
/// Declared `@freezed`. Field names mirror the backend's
/// `LoginDto` wire vocabulary (`email`, `password`) exactly, since this
...
/// not this value object or [LoginUseCase]. The backend does
/// not distinguish an unknown email from a wrong password (see
